...
generate p p > t w- h2 bottom, (h2 > t t~, (t > b w+, w+ > wdec wdec), (t~ > b~ w-, w- > wdec wdec)), (t > b w+, w+ > wdec wdec)
add process p p > t~ w+ h2 bottom, (h2 > t t~, (t > b w+, w+ > wdec wdec), (t~ > b~ w-, w- > wdec wdec)), (t~ > b~ w-, w- > wdec wdec)
output -f"""
...
evgenConfig.process= "p p ->t+W+h2 -> t+W+t+t~"
